...
$ticket->setStatus(7);
$ticket->setFecha();
$ticket->changueStatus($conexion, $_GET['id'], 5, $_SESSION['ticket_id']);
...
$mail->Subject 		= "Ticket Desautorizado #".$_GET['id'];
$mail->Body = "
  ...
  border-top-right-radius: 3px;\">
        ...
        <strong>El Ticket ha sido Desautorizado</strong>
  ...
  <div style=\"border-top: 1px solid #ddd;padding: 15px;background:white;\">  
    ...
    Hola <strong>".$resultado['personaNombre']." ".$resultado['apellido']."</strong>,<br> el ticket con id: <strong>".$_GET['id']."</strong> ha sido Desautorizado por
